...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/libdlf-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13624&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/libdlf-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `libdlf` can be installed with:

```
conda install libdlf
```

It is possible to list all of the versions of `libdlf` available on your platform with:
